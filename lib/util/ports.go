...
/*
 Table C-4
 is a listing of ports related to the Datagram Delivery Protocol (DDP)
 used on AppleTalk networks.
*/
var DDPPorts = map[int]string{
	1: "(rtmp) Routing Table Management Protocol",
	2: "(nbp) Name Binding Protocol",
	4: "(echo) AppleTalk Echo Protocol",
	6: "(zip) Zone Information Protocol",
}
